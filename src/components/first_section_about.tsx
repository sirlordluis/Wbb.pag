    ...
    <>
      <div className="px-5 max-w-[1560px] mx-auto min-h-screen pt-20 flex items-center justify-between flex-wrap ">
        <div className="w-full sm:w-8/12 mx-auto px-3">
          ...
          <h1 className="font-semibold text-[32px] text-white mb-3">
            Hello, my name is Luis Alberto, I'm{" "}
            <span className="text-[#C778DD]">software developer</span> and this
            is my portfolio.{" "}
          </h1>
          <p className="text-[#ABB2BF] my-6">
            In my free time, I like to watch animes/web series, listen to music
            (and very early stage of learning guitar), read and explore new
            stuff in tech and try out new technologies to build fun side
        ...
        <div className="mx-auto">
          <div className="">
            <img src="https://i.imgur.com/36z1wgy.png" alt="" />
          </div>
      ...
      <div className="px-5 py-10">
        <img
          ...
          src="https://i.imgur.com/QikIxco.png"
          alt=""
        />
      </div>
    </>
